...
function createMessageHtml(message, nextMessage, lastSenderId) {
    ...
    // console.log("message.sender: ", message.sender); // I populate "sender" in messages.js, so now I have all the information of the sender (it's like "joining the tables")
